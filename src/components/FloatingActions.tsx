    ...
    <div className="fixed bottom-24 right-8 z-50 flex flex-col items-end gap-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <div className="absolute right-16 bg-secondary text-secondary-foreground px-4 py-2 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap text-sm font-medium">
            Chat on WhatsApp
          </div>
